export default function PdfActionsEditor({
  ...
  const mostrarProcessar = !pdfModificadoUrl || alteracoesPendentes;

  const mostrarBaixar = pdfModificadoUrl &&  !alteracoesPendentes;
  ...
  return (
    <div className="flex-1 flex-col gap-3">
      ...
      {mostrarBaixar && (
        <>
          <button onClick={baixar} className="pro-btn-green flex gap-2 text-center items-center mt-4 justify-center "  >
